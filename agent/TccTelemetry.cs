// Attach to ONE 1-minute NQ/MNQ chart on the designated candle source VM.
...
namespace NinjaTrader.NinjaScript.Indicators
{
    public class TccTelemetry : Indicator
    {
        ...
        protected override void OnStateChange()
        {
            ...
            {
                Name = "TccTelemetry";
                Description = "Completed one-minute candle exporter for Trading Control Center Auto Quantity Beta.";
        ...
        protected override void OnBarUpdate()
        {
            if (State != State.Realtime || BarsInProgress != 0 || CurrentBar < 1
                || BarsPeriod.BarsPeriodType != BarsPeriodType.Minute || BarsPeriod.Value != 1) return;
            ...
            try
            {
                ...
                var json = new StringBuilder("{\"periodMinutes\":1,\"instrument\":\"");
