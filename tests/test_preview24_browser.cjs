...
(async()=>{
 ...
 assert.deepEqual(errors,[]);await browser.close();console.log('Preview 24 browser: sorting, live realized P&L, smaller metrics; Single Pair, editable drafts, drawdown, status colors, Central Time and persistent column resizing passed.');
